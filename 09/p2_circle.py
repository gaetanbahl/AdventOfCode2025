...
areas = []
inner_points = (points[248], points[249])

for j, p2 in enumerate(points):
    if p2[1] > inner_points[0][1]:
        o1, o2 = get_opposite_corners(inner_points[0], p2)
        if is_point_inside(o1, vertical_edges) and is_point_inside(o2, vertical_edges):
            areas.append(area(inner_points[0][0], inner_points[0][1], p2[0], p2[1]))

for j, p2 in enumerate(points):
    if p2[1] < inner_points[1][1]:
        o1, o2 = get_opposite_corners(inner_points[1], p2)
        if is_point_inside(o1, vertical_edges) and is_point_inside(o2, vertical_edges):
            areas.append(area(inner_points[1][0], inner_points[1][1], p2[0], p2[1]))
